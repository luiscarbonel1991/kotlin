...
private suspend fun withSameOrderAndContainsCriteria(
    lines1: List<String>?,
    lines2: List<String>?
) {
...
private suspend fun withContains(
    lines1: List<String>,
    lines2: List<String>
) {
   measureTimeMillis {
   ...
   }.also { println("withContains = $it milliseconds") }
}
@OptIn(ExperimentalCoroutinesApi::class)
private suspend fun withContainsBetweenFiles(
    lines1: List<String>,
    lines2: List<String>
) {
    ...
    withContext(Dispatchers.IO.limitedParallelism(4)) {
        lines1.take(200000).forEach { line1 ->
          launch {
